% example.m - ISA Toolkit example / smoke-test suite.
%
...
testCases = {
    ...
    struct( ...
        ...
        'desc', 'opts.pilot.ISA3D=true, opts.pilot.analytic=false: the numerical (BFGS) 3D projection path.', ...
        'override', @(o) setPilot(o, 'ISA3D', true))
    ...
    struct( ...
        ...
        'desc', ['opts.pilot.analytic=true, opts.pilot.ISA3D=true: the generalised closed-form ' ...
                 'solution (top-3 eigenvectors) -- exercises the 3D analytic branch specifically.'], ...
        'override', @(o) setPilot(setPilot(o, 'analytic', true), 'ISA3D', true))
...
opts.pilot.ISA3D = false;           % 2D by default; specific cases below flip this on.
