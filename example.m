...
testCases = {
    ...
    struct( ...
        ...
        'desc', ['opts.pilot.dims=3, opts.pilot.analytic=false: the numerical (BFGS) 3D projection ' ...
                 'path. Also exercises PILOTviewpoint''s default global-viewpoint path, since buildIS ' ...
                 'calls it automatically whenever dims=3.'], ...
    ...
    struct( ...
        ...
        'desc', ['opts.pilot.dims=3, opts.pilot.viewGroups={1:4,5:10}: exercises PILOTviewpoint''s ' ...
                 ...
                 'Uneven group sizes so the options.json round-trip decodes as a cell array rather ' ...
                 'than collapsing into a numeric matrix (jsonencode/jsondecode quirk).'], ...
