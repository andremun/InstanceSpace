...
tablevars = [{'z_1','z_2'},featlabels,algolabels];
writetable(array2table([out.pbldr.Z Xbackup Ybackup],...
                       'VariableNames',tablevars,...
                       'RowNames',featfiles),...
           'instance_data.csv','WriteRowNames',true);
writetable(cell2table(out.footprint.performance(2:end,2:end),...
                      'VariableNames',out.footprint.performance(1,2:end),...
