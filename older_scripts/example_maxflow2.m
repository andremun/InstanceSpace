...
opts.sifted.flag = true;                  % Run feature selection by correlation between performance and features (Step 2)
opts.sifted.rho = 0.3;
opts.sifted.K = 7;               % Default maximum number of clusters
