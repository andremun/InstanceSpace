...
writeArray2CSV(container.data.X, container.data.featlabels, ...
               container.data.instlabels, ...
               [rootdir 'feature_process.csv']);
writeArray2CSV(container.data.Yraw, container.data.algolabels, ...
               container.data.instlabels, ...
               [rootdir 'algorithm_raw.csv']);
writeArray2CSV(container.data.Y, container.data.algolabels, ...
               container.data.instlabels, ...
               [rootdir 'algorithm_process.csv']);
writeArray2CSV(container.data.Ybin, container.data.algolabels, ...
               container.data.instlabels, ...
...
writeArray2CSV(container.pythia.selection0, {'Best_Algorithm'}, ...
               container.data.instlabels, ...
