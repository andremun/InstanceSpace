...
for i=1:nalgos
    if isfield(model.trace.best{i},'polygon') && ~isempty(model.trace.best{i}.polygon)
        writeArray2CSV(model.trace.best{i}.polygon.Vertices, {'z_1','z_2'},...
                       ...
                       [rootdir 'footprint_' model.data.algolabels{i} '_best.csv']);
    end
    if isfield(model.trace.good{i},'polygon') && ~isempty(model.trace.good{i}.polygon)
        writeArray2CSV(model.trace.good{i}.polygon.Vertices, {'z_1','z_2'},...
                       ...
                       [rootdir 'footprint_' model.data.algolabels{i} '_good.csv']);
    end
    if isfield(model.trace.bad{i},'polygon') && ~isempty(model.trace.bad{i}.polygon)
        writeArray2CSV(model.trace.bad{i}.polygon.Vertices, {'z_1','z_2'},...
                       ...
                       [rootdir 'footprint_' model.data.algolabels{i} '_bad.csv']);
    end
end
...
writeArray2CSV(model.data.Xraw(:, model.featsel.idx), ...
               model.data.featlabels, ...
               model.data.instlabels, ...
               [rootdir 'feature_raw.csv']);
writeArray2CSV(model.data.X, model.data.featlabels, ...
               model.data.instlabels, ...
               [rootdir 'feature_process.csv']);
writeArray2CSV(model.data.Yraw, model.data.algolabels, ...
               model.data.instlabels, ...
               [rootdir 'algorithm_raw.csv']);
writeArray2CSV(model.data.Y, model.data.algolabels, ...
               model.data.instlabels, ...
               [rootdir 'algorithm_process.csv']);
writeArray2CSV(model.data.Ybin, model.data.algolabels, ...
               model.data.instlabels, ...
               [rootdir 'algorithm_bin.csv']);
writeArray2CSV(model.data.numGoodAlgos, {'NumGoodAlgos'}, ...
               model.data.instlabels, ...
               [rootdir 'good_algos.csv']);
writeArray2CSV(model.data.beta, {'IsBetaEasy'}, ...
               model.data.instlabels, ...
               [rootdir 'beta_easy.csv']);
writeArray2CSV(model.data.P, {'Best_Algorithm'}, ...
               model.data.instlabels, ...
               [rootdir 'portfolio.csv']);
writeArray2CSV(model.pythia.Yhat, ...
               model.data.algolabels, ...
               model.data.instlabels, ...
               [rootdir 'algorithm_svm.csv']);
writeArray2CSV(model.pythia.selection0, {'Best_Algorithm'}, ...
               model.data.instlabels, ...
