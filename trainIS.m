...
svmTable(1, 2:11) = {'Avg_Perf_all_instances';
...
svmTable(2:end, 4) = num2cell(round(100.*[mean(Ybin) 1 NaN]));
...
svmTable(2:end, 7) = num2cell(round(100.*[model.algosel.accuracy NaN mean(any(svmselections & Ybin,2))],1));
